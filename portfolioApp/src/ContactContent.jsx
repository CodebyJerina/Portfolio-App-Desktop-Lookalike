        ...
        always open. I promise I don't bite (or ghost).
         ...
         <div className="flex flex-col gap-2 mt-2">
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                    <span className="text-gray-500 text-base w-32">📞  Phone →</span> <span className="text-blue-400 text-base font-mono"> 1234567890</span>
                    </div>
                    <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-3">
                    <span className="text-gray-500 text-base w-32">🐙  GitHub →</span> <a href="https://github.com/CodebyJerina" className="text-blue-400 text-base font-mono hover:underline cursor-pointer" target="_blank" rel="noopener noreferrer">Code by Jerina ↗</a>
                    </div>
            </div>
        </div>
    )
