function WindowModal({ title, content, onClose, offset = 0 }) {
  return (
    <div style={{ top: `${100 + offset * 30}px`, left: `${200 + offset * 30}px` }} className="fixed w-3/4 h-3/4 bg-gray-900 border border-gray-600 rounded-lg shadow-2xl z-50 flex flex-col">
